...
if __name__ == '__main__':
	...
	state = [2.82402000e+04,  0., 0., 0., 3.41236793, 0., np.cos(0), 0., 0., 0., 0., 0., 0., 2*np.pi/55316.5383981744]
	#coes = [ 26600, 0.64, 63.4, 0.0, 0.0, 0.0 ] #Molniya
	sc   = SC(
			{
			'coes'       : coes,
			#'orbit_state': state,
			'actuators'	 : [0., 0., 5e-2, 0., np.pi/(1e6), 0.], #these arethe forces and torques that act with respect to the body axis
			'mass0'		 : 100.,
