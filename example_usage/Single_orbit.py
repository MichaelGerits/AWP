...
if __name__ == '__main__':
	...
	coes = [ earth[ 'radius' ] + 300, 0., 0, 0., 0., 0. ]
	state = [earth[ 'radius' ] + 5000,  0., 0., 0.,  5.91874728, 0., np.cos(np.pi/2), 0., 0., np.sin(np.pi/2), 0., 0., 0., 0.]
	...
	sc.plot_states()
	sc.plot_3d(ani = False,  args = { 'show': True, 'ani_name': 'orbit.gif', 'frames': None, 'showTime': True, 'fps': 5})
	#sc.plot_coes()
	#sc.calc_latlons()
